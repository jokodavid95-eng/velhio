    ...
    <>
      ...
      {menuOpen && (
        <div className="velhio-menu">
          ...
          <a href="https://api.whatsapp.com/send?phone=+34661764709&text=Hola%2C%20quiero%20una%20tarta" className="velhio-menu-cta" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)}>661 764 709</a>
        </div>
      )}
    </>
  )
